...
export default function Footer() {
  return (
    ...
    >
      ...
      {/* Footer Grid */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 text-center md:text-left">
      ...
      <div className="relative z-10 text-center mt-6 text-gray-400 text-sm">
        <p>
          ...
          <span className="text-[#FFD700] font-medium">Vaibhav Dhus Enterprises</span> — All Rights Reserved.
        </p>
