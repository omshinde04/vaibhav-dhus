...
const awards = [
  {
    ...
    subtitle: "Finest Awards, Nashik – Recognizing Emerging Leaders",
  },
  {
    icon: <Star size={36} className="text-[#FFD700]" />,
    title: "तक्षज्ञ गरुडझेप पुरस्कार",
    subtitle: "तक्षज्ञ फाउंडेशन – Marathi Business Excellence",
  },
  {
    icon: <Award size={36} className="text-[#FFD700]" />,
    title: "आवाज महाराष्ट्राचा",
    subtitle: "Presented by Sharad Pawar – Voice of the People",
  },
  {
    icon: <Crown size={36} className="text-[#FFD700]" />,
    title: "Most Popular Voice of Maharashtra",
    subtitle: "Finest Awards, Pune – Public Influence & Leadership",
  },
  {
    icon: <Medal size={36} className="text-[#FFD700]" />,
    title: "उद्योगरत्न पुरस्कार 2024",
    subtitle: "Business Excellence Recognition – Maharashtra",
  },
  {
    icon: <Trophy size={36} className="text-[#FFD700]" />,
    title: "Rotary Youth Icon Award",
    subtitle: "Rotary Club, Maharashtra – Youth Empowerment",
  },
  {
    icon: <Star size={36} className="text-[#FFD700]" />,
    title: "Most Popular Face of Maharashtra",
    subtitle: "Finest Awards – Statewide Recognition",
  },
  {
    icon: <Award size={36} className="text-[#FFD700]" />,
    title: "रत्नदीप पुरस्कार 2024",
    subtitle: "Cultural & Social Excellence Contribution",
  },
  {
    icon: <Crown size={36} className="text-[#FFD700]" />,
    title: "Mahashreshtha Entrepreneur Award 2024",
    subtitle: "For Outstanding Leadership and Vision",
  },
];
...
export default function Awards() {
  return (
    <section
      id="awards"
      aria-label="Awards and Recognitions Section"
    ...
    >
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "List of major awards and recognitions received by Vaibhav Dhus, including Face of Maharashtra, Takshanya Garudjhep, Rotary Youth Icon Award, and more.",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="mt-4 text-[#EAEAEA] text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed"
        >
          Honoring <span className="text-[#FFD700] font-semibold">Excellence, Leadership,</span> 
          and <span className="text-[#FFD700] font-semibold">Public Impact</span> through multiple 
          prestigious <strong>Maharashtra State Awards</strong> and national recognitions.
        </motion.p>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {awards.map((award, index) => (
            ...
            >
              ...
              <h3 itemProp="name" className="text-2xl font-bold text-[#FFD700] mb-2">
                {award.title}
              </h3>
              <p
                itemProp="description"
                className="text-gray-200 text-sm sm:text-base leading-snug"
              >
                {award.subtitle}
              </p>
